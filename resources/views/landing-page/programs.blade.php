    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
                <h2 class="section-title">Hình thức đào tạo</h2>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-5 mb-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-5 mb-5 d-flex align-items-center" data-aos="fade-up" data-aos-delay="100">
                        <img data-original="lp/images/person_transparent.png" alt="Image" class="img-fluid">
                    </div>
                    <div class="col-lg-7 mr-auto" data-aos="fade-up" data-aos-delay="200">
