...
@section('content')
    <div class="box box-success">
        ...
        <!-- /.box-header -->
        <form action="{{ route(request()->segment(2).'.update', ['id' => $educationProgram->id]) }}" method="post" class="" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="title" class="form-control" placeholder="Title" value="{{ old('title', $educationProgram->title) }}">
                        </div>
                        <div class="form-group">
                            <label>Content</label>
                            <textarea type="text" name="content" class="form-control" placeholder="Content" id="content">{{ old('content', $educationProgram->content) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
